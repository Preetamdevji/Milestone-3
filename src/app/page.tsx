          ...
          <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row mx-auto">
            <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
              ...
              <h4 className="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
                I'm {profile.name}, a Back-End | MERN Stack Developer
              </h4>
              <p className="pt-6 font-body leading-relaxed text-grey-20">
              Dedicated Full Stack Developer with over 2 years of experience
              in designing and building dynamic, user-friendly web applications. 
              Proficient in modern development tools and frameworks, 
              including JavaScript, TypeScript, SQL, NoSQL, Sanity, Express, NestJS. 
              Skilled in delivering high-quality solutions in fast-paced environments 
